...
(defroutes open-routes
  ...
  (GET "/table_ref/get_areas" [] (generate-string (table_ref/get-areas)))
  (GET "/table_ref/get_docentes" [] (generate-string (table_ref/get-docentes)))
  (GET "/table_ref/get_docentes/:id" [id] (table_ref/get-docentes-nombre id))
  ;; End table_ref
